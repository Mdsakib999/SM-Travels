...
const ContactForm = () => {
  return (
    <div className="w-full bg-gray-100">
      <div className="flex flex-col md:flex-row mx-auto min-h-screen md:min-h-[600px]">
        {/* Left: Image */}
        ...
        {/* Right: Form Section */}
        <div className="w-full md:w-1/2 bg-white p-6 sm:p-10 lg:p-12 flex flex-col justify-center">
          {/* Tag */}
          <span className="w-[120px] bg-orange-100 text-orange-600 text-sm font-medium rounded-full px-3 py-1 mb-4 text-center border border-orange-500">
            Best value
          </span>
          ...
          <form className="w-full space-y-6 flex-1">
            <div className="flex flex-col lg:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <input
                type="text"
                placeholder="Name*"
                className="w-full flex-1 p-3 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-600"
              />
              <input
                type="text"
                placeholder="Surname*"
                className="flex-1 p-3 md:mt-5 lg:mt-0 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-600"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full p-3 bg-orange-500 text-white rounded-md flex items-center justify-center gap-2 text-lg hover:bg-orange-600 transition-all"
            >
      ...
      <div className="w-full bg-zinc-100 py-8 flex flex-col items-center justify-center">
